          ...
          <table cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: white;">
              <tr>
                  <td style="background-color: #1a1a1a; padding: 20px; text-align: center;">
                      <img src="/api/placeholder/150/50" alt="Credulen Logo" style="height: 50px;">
                  </td>
              </tr>
              <tr>
              ...
              <tr>
                  <td style="padding: 0 20px 40px;">
                      ...
                      <p style="color: #666; font-size: 16px; line-height: 1.5;">
                          In the meantime, if you have any questions, please don't hesitate to reach out to our support team at <a href="mailto:support@Credulen.com" style="color: #0066cc; text-decoration: none;">credulen@gmail.com</a>
                      </p>
                  </td>
              </tr>
              <tr>
